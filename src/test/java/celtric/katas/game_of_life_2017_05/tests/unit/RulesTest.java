...
public final class RulesTest {
    ...
    @Test
    public void any_live_cell_with_more_than_three_live_neighbours_dies_as_if_by_overpopulation() {
        assertFalse(Neighbourhood.of(4).isNextGenerationAlive(true));
        assertFalse(Neighbourhood.of(8).isNextGenerationAlive(true));
    }

    @Test
    public void any_dead_cell_with_exactly_three_live_neighbours_becomes_a_live_cell_as_if_by_reproduction() {
        assertTrue(Neighbourhood.of(3).isNextGenerationAlive(false));
    }

    @Test
    public void any_dead_cell_remains_dead_if_not_located_in_a_fertile_neighbourhood() {
